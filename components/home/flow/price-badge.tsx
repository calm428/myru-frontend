...
function PriceBadge({ children, className }: SectionBadgeProps) {
  return (
    <Badge
      variant='outline'
    ...
    >
      <div className='absolute inset-0 bg-gradient-to-b from-transparent to-primary/10 opacity-0 transition-opacity duration-300 group-hover:opacity-100'></div>
